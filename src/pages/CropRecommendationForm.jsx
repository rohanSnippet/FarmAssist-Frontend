  ...
  Sparkles: (
    ...
    >
      <path
        ...
        d="M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09zM18.259 8.722L17.25 11.25l-1.009-2.528a1.125 1.125 0 00-.713-.713L13 7l2.528-1.009a1.125 1.125 0 00.713-.713L17.25 4.25l1.009 2.528a1.125 1.125 0 00.713.713L21.5 7l-2.528 1.009a1.125 1.125 0 00-.713.713z"
      />
    </svg>
  ),
  Sync: (
                      ...
                      <div className="space-y-6">
                        ...
                        {[
                          ...
                          <div key={f.name} className="form-control">
                            ...
                            <div
                              className={`input input-bordered rounded-sm flex items-center gap-3 bg-base-200/20 focus-within:bg-base-100 focus-within:border-primary transition-all ${errors[f.name] ? "input-error" : ""}`}
                            >
                              {f.icon}
                              <input
                                type="number"
                      ...
                      <div className="space-y-6 lg:col-span-2">
                        <div className="flex justify-between items-end border-b border-base-content/10 pb-2">
                          ...
                          <button
                            ...
                            className="btn btn-xs btn-ghost text-primary hover:bg-primary/10 rounded-sm"
                          >
                            {loadingWeather ? (
